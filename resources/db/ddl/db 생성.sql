...
CREATE TABLE `StoreCategory` (
  ...
  `placeCtgName` varchar(100) NOT NULL COMMENT '장소 카테고리 이름',
  `options` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL COMMENT '추가정보' CHECK (json_valid(`options`)),
  `createdAt` timestamp NULL DEFAULT current_timestamp() COMMENT '생성시간',
  `updatedAt` timestamp NULL DEFAULT current_timestamp() COMMENT '수정시간',
  PRIMARY KEY (`name`),
  KEY `FK_PlaceCategory_TO_StoreCategory` (`placeCtgName`),
  CONSTRAINT `FK_PlaceCategory_TO_StoreCategory` FOREIGN KEY (`placeCtgName`) REFERENCES `PlaceCategory` (`name`)
...
CREATE TABLE `Store` (
  ...
  `placeCtgName` varchar(100) NOT NULL COMMENT '장소 카테고리 명',
  ...
  KEY `FK_PlaceCategory_TO_Store` (`placeCtgName`),
  CONSTRAINT `FK_PlaceCategory_TO_Store` FOREIGN KEY (`placeCtgName`) REFERENCES `PlaceCategory` (`name`),
...
CREATE TABLE `MyOrder` (
  ...
  `storeNm` varchar(45) NOT NULL COMMENT '매장 명',
  ...
  PRIMARY KEY (`seq`),
  KEY `FK_Store_TO_MyOrder` (`storeNm`),
  CONSTRAINT `FK_Store_TO_MyOrder` FOREIGN KEY (`storeNm`) REFERENCES `Store` (`name`)
...
CREATE TABLE `OrderMenu` (
  ...
  `cnt` tinyint(4) NOT NULL COMMENT '수량',
  PRIMARY KEY (`name`,`orderSeq`),
  KEY `FK_MyOrder_TO_OrderMenu` (`orderSeq`),
  CONSTRAINT `FK_Menu_TO_OrderMenu` FOREIGN KEY (`name`) REFERENCES `Menu` (`name`),
...
CREATE TABLE `OrderRsv` (
  ...
  `updatedAt` timestamp NULL DEFAULT current_timestamp() COMMENT '수정시간',
  PRIMARY KEY (`seq`),
  KEY `FK_Store_TO_OrderRsv` (`storeNm`),
  CONSTRAINT `FK_Store_TO_OrderRsv` FOREIGN KEY (`storeNm`) REFERENCES `Store` (`name`)
...
CREATE TABLE `OrderMenuRsv` (
  `menuNm` varchar(45) NOT NULL COMMENT '메뉴 명',
  `orderRsvSeq` bigint(20) unsigned NOT NULL COMMENT '주문예약 Seq',
  `price` int(10) unsigned NOT NULL COMMENT '가격 menu는 가격이 바뀔수가 있음',
  `cnt` tinyint(3) unsigned NOT NULL COMMENT '수량',
  PRIMARY KEY (`menuNm`,`orderRsvSeq`),
  KEY `FK_OrderRsv_TO_OrderMenuRsv` (`orderRsvSeq`),
  CONSTRAINT `FK_Menu_TO_OrderMenuRsv` FOREIGN KEY (`menuNm`) REFERENCES `Menu` (`name`),
