...
const mappings: Mapping[] = [
    {
        ...
        to: 'm_setting',
        columns: ['seq', 'config'],
        transform: (r) => [r.seq, toJsonb(r.config)],
    },
    {
        from: 'StoreCategory',
        to: 'm_store_category',
    ...
    },
    {
        from: 'Store',
        to: 'm_store',
        columns: ['seq', 'ctg_seq', 'nm', 'addr', 'cmt', 'latitude', 'longitude', 'options', 'reg_at', 'mod_at'],
        transform: (r) => [
            r.seq,
            r.ctgSeq,
            r.name,
    ...
    },
    {
        from: 'Menu',
        to: 'm_menu',
        columns: ['seq', 'ctg_seq', 'nm', 'nm_s', 'price', 'cmt', 'options', 'reg_at', 'mod_at'],
        transform: (r) => [
            r.seq,
            r.ctgSeq,
            r.name,
    ...
    },
    {
        from: 'ProductInfo',
        to: 'm_product_info',
        columns: ['seq', 'ingd_seq', 'nm', 'cmt', 'options', 'reg_at', 'mod_at'],
        transform: (r) => [
            r.seq,
    ...
    },
    {
        from: 'Product',
        to: 'm_product',
        columns: ['seq', 'prd_info_seq', 'unit_seq', 'unit_cnts'],
        transform: (r) => {
            ...
            return [r.seq, r.prdInfoSeq, r.unitSeq, arr]
        },
    },
    {
        ...
        from: 'OrderRsv',
        to: 'm_order_rsv_tmpl',
        columns: ['seq', 'store_seq', 'nm', 'amount', 'rsv_time', 'day_types', 'cmt', 'active', 'start_dt', 'end_dt', 'options', 'reg_at', 'mod_at'],
        transform: (r) => [
            r.seq,
            r.storeSeq,
